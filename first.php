			...
			<div class="container">
				...
				<div class="nav navbar-nav navbar-right social-icons wow fadeInRight animated" data-wow-delay=".5s">
					<ul>
						...
						<li><a href="https://www.facebook.com/mobilemlucknow/" target="_blank" class="fa fa-facebook"><i class="fa fa-facebook"></i> </a></li>
		...
		<div class="header-two navbar navbar-default"><!--header-two-->
			<div class="container">
				<div class="nav navbar-nav header-two-left">
					<ul>
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">mobilemlucknow@gmail.com</a></li>			
					</ul>
				</div>
				<div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s">
				      <a href="./">
                        <img src="images/Mobile%20M%20logo.png" alt="Mobile M Logo" title="Mobile Market Logo" class="img-responsive" style="height:100px; " />                   
			...
			if(isset($_SESSION["SystemID"]))
			{
				$systemid=$_SESSION["SystemID"];
                    ...
                    ?>
								<span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"><?php echo $cartcount; ?></span>) 
								<!-------------cart ---------------------->
