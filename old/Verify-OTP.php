	...
	<!---------------------otp -------------------------->
	 ...
	 <?php
		...
		<div class="container-fluid">
            ...
            <?php
                $sql1="select Mobile from registration where UserID='$userid'";
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <form action="manage/manage.customerregistration.php?action=otp" method="post" >
                        <div class="form-group">
                            <span class="help-block" >
							  ...
							  <hr/>
			                   <p> We have sent an 6 digits OTP (One Time Password) to your registered mobile number  </p>
                                ...
                                <?php echo $row1["Mobile"]; ?> <button class="btn btn-info btn-sm" type="button" onclick="changemobile('<?php echo $row1["Mobile"]; ?>')" ><i class="fa fa-edit"></i></button>,
