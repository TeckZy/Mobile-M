	...
	<div class="login-page">
		...
		<div class="widget-shadow">
			...
			<div class="login-body wow fadeInUp animated" data-wow-delay=".7s">
				<form action="manage/manage.MyProfilecode.php?flag=2" method="post" >
				      
				     <p>New Password</p>
                     <input type="text" name="new" class="user" id="email" placeholder="Enter New Password" required /> 
                      					 
                      <p>Confirm Password</p>					 
					  <input type="text" name="con" class="lock" id="password" placeholder="Enter Password" />
