									...
									<div class="row">
										 <div class="col-lg-3 col-xs-6 header-logo ">
												<div class="navbar-logo">
													 <a href="#"><img src="image/logo/logo-header.png" alt="MobileM" width="110" height="27" title="MobileM"></a>
												</div>
										 </div>
													 ...
													 <div class="clearfix sevices-menu">
															<ul>
																 <li class="col-md-4 item home">
																		<div class="icon"></div>
																		<div class="text">
																			 <a> Shop No. UGF D-2,</a><a>
																			
																			 </a>
																			 <p><a> Arif Vikas Chamber</a></p>
																			 <p><a> Lucknow, Uttar Pradesh</a></p>
																			 <a>
																			 </a>
																		</div>
																 </li>
																 <li class="col-md-4 item mail">
																		<div class="icon" > </div>
																		<div class="text">
																			 <a class="name" href="mailto:mobilemlucknow@gmail.com">mobilemlucknow@gmail.com</a>
																			 <p> (639)4777570</p>
																			 <p> (955)4387950</p>
																		</div>
																 </li>
																 ...
																 <div class="modcontent">
																		<div id="sohomepage-slider1">
																			 ...
																			 <?php
																								...
																								$q = $db->query(sprintf($s1)) or die('Error');
																								$i = 0;
																			...
																			?>
																					...
																					<div class="item">
																						 <a href="#<?php $i = $i + 1;
                                              echo $i ?>!"    title="slide 1 -<?php echo $i ?>" target="_self">
																						 <img class="responsive" src="image/home/slider/<?php echo $row[1]; ?>" alt="slide 1 - 1">
																						 </a>
