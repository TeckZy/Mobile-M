				...
				<div id="login" class="col s12">
					<form id="loginForm" action="manage/manage.customerlogin.php" method="post">
						...
						<div class="input-field col s6">
							<input required="" aria-required="true" type="text" name="email" class="user" id="email" required />
							<label for="email">Enter Email</label>
						</div>

						<div class="input-field col s6">
							<input required="" aria-required="true" type="password" name="password" class="lock" id="password" />
							<label for="password">Enter Password</label>
						</div>
						<button onClick="SUBMIT('#loginForm')" class="waves-effect waves-green btn" name="Sign In">Sign In</button>
				...
				<div id="register" class="col s12">
					<form id="regForm" action="manage/manage.customerregistration.php" method="post" class="col s12">
						<div class="form-container">
							...
							<div class="row">
								<div class="input-field col s6">
									<input type="number" value="7054796555" name="mobile" class="validate" id="mobile" />
									<label for="mobile">Mobile</label>
								</div>
								<div class="input-field col s6">
									<input type="email" value="nishu@gmail.com" name="email" class="validate" id="email" />
							...
							<div class="row">
								<div class="input-field col s12">
									<input type="password" value="nishu" name="password" class="validate" id="password" />
							...
							<center>
								<button class="btn waves-effect waves-light teal" onClick="SUBMIT('#regForm')" name="action">
									Submit
								</button>
							</center>
						</div>
      ...
      ?>
        <div class="col s12 m3 l3 center">
          <a href="single.php?mobile=<?php echo urlencode($rowproduct["Name"]); ?>&id=<?php echo $rowproduct["ProductID"]; ?>">
            <img style="width:100px; height:200px;" src="Admin/productsimg/<?php echo $rowproduct["Image1"]; ?>" class="responsive-img" alt="">
          </a>
          <div class="card hoverable animate fadeLeft">
            <div class="card-image">
              ...
              ?>
                <a class="btn-floating halfway-fab waves-effect waves-light red" href="manage/manage.cart.php?action=add&pid=<?php echo $rowproduct["ProductID"]; ?>" style=" font-size:15px;">
              ...
              ?>
                <a href="#" disabled data-toggle="tooltip" data-placement="bottom" title="Add To Cart"></a> <label class="label label-warning">Out of Stock</label>
              <?php
              }
              ?>
            </div>
            <div class="card-content">
              ...
              <div class="display-flex flex-wrap justify-content-center">
                ...
                <a href="single.php?mobile=<?php echo urlencode($rowproduct["Name"]); ?>&id=<?php echo $rowproduct["ProductID"]; ?>" class="mt-2 waves-effect waves-light gradient-45deg-deep-purple-blue btn btn-block modal-trigger z-depth-4">View</a>
              </div>
            </div>
          </div>
