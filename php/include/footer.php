																 ...
																 <div class="module news-letter">
																		<div class="so-custom-default newsletter" style="width:100%     ; background-color: #f0f0f0 ; ">
																			 <div class="btn-group title-block">
																					...
																					<div class="newsletter_promo">And receive <span>INR 20</span>coupon for first shopping</div>
																			 </div>
															...
															<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 col_h1e7 block--social">
																 <div class="footer-social">
																		...
																		<div class="socials">
																			 ...
																			 <a href="https://plus.google.com/u/0/" class="google" target="_blank">
													 ...
													 <div class="row row_wprs  ">
															<div class="col-lg-15 col-md-15 col-sm-4 col-xs-6 col_yb5e footer--link">
																 ...
																 <ul class="links">
																		...
																		<li>
																			 <a href="#"> 100000 -12000</a>
																		</li>
																		<li>
																			 <a href="#">12000 - 20000</a>
																		</li>
																		<li>
																			 <a href="#"> 20000 - 30000</a>
																		</li>
																		<li>
																			 <a href="#"> 30000 - above</a>
																		</li>
																 </ul>
															</div>
																 ...
																 <div class="contactinfo">
																		...
																		<div class="content-footer">
																			 <div class="address">
																					...
																					<span> Shop No. UGF D-2, Arif Vikas Chamber, Sector-2, Vikash Nagar, Lucknow, Uttar Pradesh - 226022</span>
																			 </div>
																			 <div class="phone">
																					<label><i class="fa fa-phone" aria-hidden="true"></i></label>
																					<span>+91-6394777570  -  +91-9554387950</span>
																			 </div>
																			 <div class="email">
																					<label><i class="fa fa-envelope"></i></label>
																					<a href="#">mobilemlucknow@gmail.com</a>
																			 </div>
																		</div>
																 </div>
							 ...
							 <div class="container">
									<div class="row">
										 <div class="col-md-7  col-sm-7 copyright">
												So TopDeal © 2016 - 2018. All Rights Reserved. Designed by <a href="" target="_blank">Teckzy</a>
										 </div>
									</div>
							 </div>
						</div>
