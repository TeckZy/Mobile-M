<!--footer-->
		...
		<div class="container">
			<div class="footer-info">
				<div class="col-md-3 footer-grids wow fadeInUp animated" data-wow-delay=".5s">
					<h2 class="footer-logo"><a href="index.php" style="color:Tomato; text-shadow:1px 1px black; font-size:20px;">About <b style="color:black; text-shadow:1px 1px white; font-size:20px;">Store</b> 
					 </a></h2>
					<p style="text-align: justify; font-size:17px;">MobileM.in is an Online Mobile Market for Users.
                    From this website you can purchase new mobile phones or you can post you ad for old mobile phone.<a href="about.php" class="link1" style="color:red;">&nbsp; &nbsp;More...</a></p>
					 <ul style="margin-top:5px;">
						<li class="pull-right">
						</li>
					 </ul>
					  <br/>
					 <img src="images/Mobile%20M%20logo.png" style="height:50px;" alt="Mobile M logo" class="img-responsive logo"  />
				</div>
				...
				<img class="img-responsive" src="images/f.jpg" style="height:40px;border-radius:50%;float:left;"/>  &nbsp; &nbsp;Facebook</a></li> <br/>
				<li><a href="#" class="link2"> <img class="img-responsive" src="images/t.png" style="height:40px;border-radius:50%;float:left;"/> &nbsp;&nbsp; Twitter</a></li> <br/>
				<li><a href="https://plus.google.com/u/0/111711733413589353055" class="link2"> <img class="img-responsive" src="images/gg.png" style="height:40px;border-radius:50%;float:left;"/> &nbsp;&nbsp;Google+</a></li> <br/>
				<li><a href="#" class="link2"> <img class="img-responsive" src="images/i.png" style="height:40px;border-radius:50%;float:left;"/>&nbsp;&nbsp;LinkedIn</a></li> <br/>
				<li><a href="#" class="link2"> <img class="img-responsive" src="images/y.png" style="height:40px;border-radius:50%;float:left;"/> &nbsp; &nbsp;YouTube</a></li>	<br/>					
				</ul>
				...
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".7s">
					...
					<ul class="address1">
						<li><i class="fa fa-smile-o" style="font-size:16px; color:Tomato;text-shadow:0px 1px black;"></i>&nbsp;&nbsp;<span>MobileM.in (Mobile Market)</span></li>
						<li> <i class="fa fa-map-marker"></i>&nbsp;&nbsp;Shop No. UGF D-2, Arif Vikas Chamber, Sector-2, Vikash Nagar, Lucknow, Uttar Pradesh - 226022</li>
	...
	<!--//footer-->	
  <div class="col-sm-12 wow fadeInUp animated" id="footer2" data-wow-delay=".7s" style=" background-color:#353F49;  line-height:55px; margin-top:20px;">
			<div class="col-sm-6" style="color:white; font-family: 'IBM Plex Serif', serif;">
				...
				<p style="color:white;">Powered by - <a style="color:white;" href="http://www.pnpintech.com" target="_blank"> PNPLRC (P) Ltd.</a> </p>
				</div>
		</div>
	<div class="prog">
